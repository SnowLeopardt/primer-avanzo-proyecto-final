...
<head>
    ...
    <style>
        ...
        .tabla-container {
            ...
            box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);
            width: 80%;
            margin: -50px auto 50px auto; /* Mueve la tabla hacia abajo 50px y la centra horizontalmente */
            overflow-x: auto;
            margin-top: -100px; /* Ajusta la posición de la tabla hacia arriba */
        }
...
<body>
    <div class="registro-container">
        <h2>Registro de Contenedor</h2>
        <form id="formulario-registro" action="procesar_registro_contenedor.php" method="post" enctype="multipart/form-data">
    ...
    <div class="tabla-container">
        ...
        function searchTable() {
            ...
            $sql = "SELECT id, empresa, direccion, fecha FROM contenedores";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='7'>No se encuentran contenedores.</td></tr>";
            }
    ...
    function eliminarRegistro(id) {
        if (confirm("¿Estás seguro de que deseas eliminar este contenedor?")) {
            ...
            xhr.open("POST", "eliminar_registro_contenedor.php", true);
...
<script>
    ...
    function editarRegistro(id) {
        ...
        window.location.href = "editar_registro_contenedor.php?id=" + id;
    }
</script>
