...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM contenedores WHERE id = $id";
...
<head>
    ...
    <title>Editar Registro de Contenedores</title>
...
<body>
    <div class="registro-container">
        <h2>Editar Registro de Contenedores</h2>
        <form id="formulario-edicion" action="procesar_edicion_contenedor.php" method="post">
            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
            <input type="text" name="empresa" placeholder="Nombre de la Empresa" value="<?php echo $row['empresa']; ?>" required>
            ...
            <button class='cancelar' type="button" onclick="window.location.href='contenedor.php'">Cancelar</button>
        </form>
    </div>
</body>
</html>
